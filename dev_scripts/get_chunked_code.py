...
from punito.utils import read_file, save_json_to_txt
import json
...
def main():
    ...
    save_json_to_txt(json.dumps(chunked_code), Path(__file__).parent / "debug" / "get_chunked_code" / "chunked_code.txt" )
